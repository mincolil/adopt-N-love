...
const
  ...
  ModalEditPet = (props) => {
    ...
    const [adoptDes, setAdoptDes] = useState({});
    ...
    useEffect(() => {
      if (open) {
        ...
        setFacebook(dataEditPet.facebook);
        setAdoptDes(dataEditPet.adoptDescription);
        setForAdoption(dataEditPet.forAdoption);
            ...
            <form>
              ...
              {forAdoption && (
                <>
                  ...
                  <TextField
                    fullWidth
                    label="Miêu tả nhận nuôi"
                    margin="normal"
                    value={adoptDes}
                    onChange={(e) => setAdoptDes(e.target.value)}
                  />
                </>
              )}
