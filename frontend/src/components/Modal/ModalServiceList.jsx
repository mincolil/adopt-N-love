...
import "../../layouts/LandingPage/Service/styled/ServiceList.css";
...
import ChoosePet from "../Modal/ModalChoosePet";
...
function ServiceItem({ service, pet }) {
    ...
    return (
        ...
        <Dialog
            ...
            sx={{
                ...
                width: "80vw", // Adjust the width to 80% of the viewport width
                height: "80vh", // Adjust the height to 80% of the viewport height
                padding: "200px",
            }}
        >
            <IconButton
            ...
            {contextHolder}
            <Grid container spacing={1} sx={{ padding: "50px" }}>
                        ...
                        <Grid container spacing={2}>
                            {!data || data.length === 0 ? (
                                ...
                                data.map((service, index) => (
                                    <ServiceItem key={index} service={service} pet={pet} />
                                ))
                            )}
                        </Grid>
                        <Stack
