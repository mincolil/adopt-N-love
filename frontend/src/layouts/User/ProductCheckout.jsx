      ...
      >
        <Grid container spacing={5}>
          ...
          <Grid item xs={5}>
            ...
            <Typography>
              {" "}
              <strong>* Lưu ý:</strong> Sau khi điền đầy đủ thông tin chính xác,
              ấn đặt hàng, đơn hàng của bạn sẽ được chúng tôi chuẩn bị và giao
              hàng. Tùy vào địa chỉ, bạn sẽ nhận hàng vào từ 2-4 ngày tới. Hãy
              chú ý điện thoại để nhận hàng, sau đó kiểm tra kỹ đơn hàng sau đó
              mới thanh toán, nếu có vấn đề gì về đơn hàng hãy liên lạc cho
              chúng tôi để giải quyết.
            </Typography>
            <button
              style={{
                cursor: "pointer",
